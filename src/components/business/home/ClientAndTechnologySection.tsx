  ...
  return (
    <div>
      ...
      <section className="relative">
        <div
          className="business-container bg-white flex justify-end absolute 
                    top-[-32px] 
                    right-0 
            ...
            >
              ...
              <div className="space-y-2">
                {faqs.slice(0, 4).map((faq, i) => (
                  ...
                  >
                    <button
                      ...
                      className={`w-full flex justify-between items-center text-left font-medium text-gray-800 p-4 ${
                        activeIndex === i
                    ...
                    <AnimatePresence>
                      {activeIndex === i && (
                        <motion.div
                          ...
                          className="flex gap-4 text-sm text-gray-600 p-4 bg-primary/10"
                        >
                          <p>{faq.answer}</p>
                        </motion.div>
                      )}
                ...
                <div>
                  <Link
                    to={"/faq"}
                    className="flex flex-row items-center justify-center text-primary hover:underline"
                  >

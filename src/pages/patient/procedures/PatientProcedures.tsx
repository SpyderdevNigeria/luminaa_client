      ...
      render: (procedure) => (
            <Dropdown showArrow={false} triggerLabel="" triggerIcon={<HiOutlineDotsVertical />}>
                  <ul className="space-y-2 text-sm">
                    <li >
                      <Link className="cursor-pointer hover:bg-gray-100 p-1 rounded flex items-center gap-2" to={`${ routeLinks?.patient?.procedures }/${procedure.id}`}> <FiEye /> View</Link>
                    </li>
                  </ul>
                </Dropdown>
      ),

...
function BookingDetails() {
  ...
  if (!appointment) return <div className="flex flex-col items-center justify-center h-[500px]">Loading Appointment Details ...</div>;

  return (
    <main className="max-w-[500px] mx-auto md:mx-auto border border-gray-light rounded-lg p-4 md:p-6 animate-fade-in my-12">

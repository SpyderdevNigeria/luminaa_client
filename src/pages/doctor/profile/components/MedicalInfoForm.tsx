...
const MedicalInfoForm: React.FC<MedicalInfoFormProps> = ({
 ...
 <main className="bg-white rounded-lg border border-dashboard-gray max-w-6xl mx-auto">
    ...
    <h4 className="text-2xl 2xl:text-4xl ">Update Medical Information</h4>
        <IoClose className="text-2xl 2xl:text-4xl text-dashboard-gray cursor pointer " onClick={handleClose} />
    </div>
      ...
      <div className="flex items-start justify-center">
        ...
        >
          ...
          <p >File Format <span className="text-black">jpeg, png</span>   Recommended Size <span className="text-black">600×600 (1:1)</span> </p>
        </div>
      </div>
    </div>
 </main>
